            ...
            {amcPlans.map((plan) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-7">
                  ...
                  <Link
                    to="/contact"
                    className={`mt-7 inline-flex w-full items-center justify-center gap-2 rounded-full px-5 py-3 text-sm font-semibold transition-all duration-200 ${plan.featured ? 'bg-accent text-white shadow-lg shadow-accent/30 hover:bg-[#0094b8]' : 'border border-border text-foreground hover:border-accent hover:text-accent'}`}
                  >
                    Get Started
                    <ArrowRight size={15} />
                  </Link>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 sm:px-6 lg:grid-cols-12 lg:px-8">
          <div className="lg:col-span-5">
            ...
            <div className="mt-8 flex flex-col gap-3">
              {['Preventive maintenance', 'Fast repair support', 'Clear service timing'].map(
                (title) => (
                  <div
                    key={title}
