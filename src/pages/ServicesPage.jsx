        ...
        <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div>
            ...
            <p className="mt-7 max-w-xl text-base font-medium leading-relaxed text-muted-foreground sm:text-lg">
              From compact home purifiers to commercial RO systems and industrial treatment plants,
              ATROS helps customers choose, install, and maintain dependable water purification
              systems.
            </p>
            ...
            {serviceGroups.map((service, index) => {
              ...
              return (
                <article
                  key={service.id}
                  id={service.id}
                  className="group grid grid-cols-1 overflow-hidden rounded-3xl border border-border bg-white shadow-sm transition-all duration-500 hover:border-accent/20 hover:shadow-xl hover:shadow-accent/8 lg:grid-cols-2"
                >
                  <div
                  ...
                  <div className="flex flex-col justify-center p-7 sm:p-10">
                    ...
                    <Link
                      to="/contact"
                      className="mt-7 inline-flex w-fit items-center gap-2 text-xs font-bold uppercase tracking-wide text-accent transition-colors hover:text-primary"
                    >
                      Enquire Now
                      <svg
                        width="12"
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 sm:px-6 lg:grid-cols-12 lg:px-8">
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 text-base leading-relaxed text-muted-foreground">
              ...
              hardness, TDS, expected daily consumption, available space, and service access before
          ...
          <div className="lg:col-span-7">
            <ol className="grid gap-4">
              {selectionSteps.map((step, index) => (
                <li key={step} className="gradient-border-card flex items-center gap-5 bg-white p-5">
