...
const products = [
  {
    ...
    description:
      'Advanced water purification with excellent TDS removal and premium storage capacity',
  },
  {
  ...
  },
  {
    ...
    description:
      'Multi-stage purification with RO, UV, and UF technology for complete water safety',
  },
  {
  ...
  },
  {
    ...
    description:
      'Premium water purification system with proven RO and UV technology combination',
  },
  {
  ...
  },
  {
    ...
    description:
      'Premium RO+UV purifier with copper and mineral enrichment technology for health',
  },
  {
    name: 'Aqua Health Care 50 LPH Commercial RO System',
    price: 'Rs. 31.5 K - Rs. 35.0 K',
    unit: '',
    ...
    description:
      'Professional commercial water purification system ideal for offices and businesses',
  },
  {
    name: 'XPRIA Advanced Water Purification System',
    price: 'Rs. 14.8 K - Rs. 16.5 K',
    unit: '',
    type: 'Electrical & Storage',
    ...
    description:
      'Professional-grade multi-stage purification with RO, UV, and microfiltration',
  },
];
...
export default function ProductsPage() {
  return (
    <SiteShell
      showPageEffects
      showStructuredData
      mainClassName="page-transition-root animated-page product-page"
    >
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              ...
              >
                <p className="font-display text-xl font-bold text-primary">{stat.val}</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <h2 className="text-2xl font-bold text-foreground md:text-3xl">
              Water Purifiers <span className="text-lg font-normal text-muted-foreground">(100+ products)</span>
            </h2>
            <Link
              to="/contact"
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {products.map((product) => (
              <article
                key={product.name}
                className="group flex flex-col overflow-hidden rounded-2xl border border-border bg-white shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-accent/30 hover:shadow-xl hover:shadow-accent/10"
              >
                <div className="relative flex aspect-[4/3] w-full items-center justify-center overflow-hidden bg-gray-50 p-3">
                  <img
                    src={product.image}
                    alt={product.alt}
                    ...
                    loading="lazy"
                  />
                  <div className="absolute left-3 top-3 rounded-full bg-primary/90 px-2.5 py-1 text-[9px] font-bold uppercase tracking-widest text-white">
                    {product.category === 'commercial' ? 'Commercial' : 'Home'}
                  </div>
                </div>
          ...
          <div className="gradient-border-card product-help-card mt-10 bg-white p-8 text-center">
            ...
            <h3 className="text-base font-bold text-foreground">Looking for a specific product?</h3>
            <p className="mt-2 text-sm text-muted-foreground">
              ATROS stocks 100+ water purifier models. Contact us for availability, pricing and
              custom requirements.
            </p>
            <Link to="/contact" className="btn-primary-glow mt-5 inline-flex items-center gap-2">
              Talk to an Expert
              <ArrowRight size={15} />
            </Link>
          </div>
