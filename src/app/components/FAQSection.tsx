...
const faqs = [
  {
    ...
    answer: 'RO-based systems are generally recommended for borewell water with high TDS levels. Our experts will test your water TDS and recommend the right system — typically an RO+UV or RO+Alkaline combination for borewell water sources.',
  },
  {
    question: 'How often should filters be changed?',
    answer: 'Filter replacement depends on usage and water quality, usually every 6 to 12 months. With our AMC package, we schedule timely filter replacements so you never have to worry about maintenance.',
  },
  {
    question: 'Do you provide professional installation services?',
    answer: 'Yes, professional installation services are available. Our trained technicians handle complete installation including pipe fitting, wall mounting, and quality testing — usually completed the same day or the next business day.',
  },
  {
    question: 'Is Annual Maintenance Contract (AMC) support available?',
    answer: 'Yes, affordable annual maintenance contracts are provided. Our AMC plans include regular servicing, filter replacements, and priority technical support at a fixed yearly cost — saving you from unexpected repair expenses.',
  },
  {
    question: 'Do you handle commercial and industrial projects?',
    answer: 'Yes, we provide customized solutions for commercial and industrial applications. From high-capacity office RO systems to large-scale industrial water treatment plants, our team designs and installs solutions tailored to your specific requirements.',
  },
  {
    question: 'Can you repair existing RO systems from other brands?',
    answer: 'Yes, repair and servicing support is available for various purification system brands. Our technicians are trained to diagnose and fix issues with most RO, UV, and UF purifier models. Contact us for a service appointment.',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-4">
            <span className="section-label mb-5 block">05 — FAQ</span>
            ...
            <p className="text-muted-foreground text-base leading-relaxed mb-8" style={{ fontFamily: 'Inter, sans-serif' }}>
              Have more questions? Our water purification experts are available Monday–Sunday,
              9:30 AM to 9:00 PM.
            </p>
            ...
            <div className="gradient-border-card bg-white p-5 mb-5 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <p className="font-semibold text-foreground text-sm" style={{ fontFamily: 'Inter, sans-serif' }}>Call Our Experts</p>
                  <p className="text-muted-foreground text-xs" style={{ fontFamily: 'Inter, sans-serif' }}>Mon–Sun, 9:30 AM – 9:00 PM</p>
                </div>
              </div>
              <a
              ...
              {faqs.map((faq, i) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{ maxHeight: openIdx === i ? '300px' : '0', opacity: openIdx === i ? 1 : 0 }}
                  >
                    <p className="text-muted-foreground text-sm leading-relaxed pb-5" style={{ fontFamily: 'Inter, sans-serif' }}>
                      {faq.answer}
                    </p>
                  </div>
                </div>
