...
export default function WhatsAppFloat() {
  ...
  return (
    <div
      className="fixed bottom-7 right-7 z-[999] flex items-center gap-3"
      style={{
        opacity: visible ? 1 : 0,
    ...
    >
      ...
      >
        💬 Chat with us!
        <div className="absolute right-[-6px] top-1/2 -translate-y-1/2 w-3 h-3 bg-white border-r border-t border-border/50 rotate-45" />
      </div>

      {/* Button */}
      <a
        href="https://wa.me/919080232624?text=Hi%20ATROS%2C%20I%20need%20help%20with%20water%20purification."
        target="_blank"
