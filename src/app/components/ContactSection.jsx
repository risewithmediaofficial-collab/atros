          ...
          <div className="contact-left lg:col-span-5 flex flex-col gap-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <a
                ...
                style={{
                  background: 'linear-gradient(135deg, #0A4D68, #0077A8)',
                  boxShadow: '0 8px 24px rgba(10,77,104,0.3)',
                }}
              >
                <svg
                  width="16"
            ...
            <div className="gradient-border-card bg-white p-5 shadow-sm">
              ...
              <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  [
                    'Mode of Payment',
                    'Cash, UPI, Visa / Master Card / Rupay, Net Banking, Paytm, PhonePe, Amazon Pay, Cheque / Demand Draft, EMI Financing',
                  ],
                ].map(([label, value]) => (
