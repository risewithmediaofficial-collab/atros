...
const steps = [
  {
    ...
    description: 'We analyze your water source — borewell, municipal, tanker, or hard water — and recommend the ideal purification solution.',
    icon: (
  ...
  },
  {
    ...
    description: 'Our experts suggest the right system based on your water quality, family size, daily usage, and budget.',
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
  ...
  },
  {
    ...
    description: 'Quick, clean installation by our trained technicians. Typically completed within the same or next business day.',
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
  ...
  },
  {
    ...
    description: 'Regular maintenance, filter replacement, and technical support. Available Mon–Sun, 9:30 AM to 9:00 PM.',
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
    ...
    <section ref={sectionRef} className="py-24 bg-background overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="section-label mb-5 mx-auto block w-fit">03 — How It Works</span>
            ...
            {steps?.map((step, i) => (
              ...
              >
                ...
                <div className="gradient-border-card bg-white p-6 h-full hover:shadow-2xl hover:shadow-accent/10 hover:-translate-y-2 transition-all duration-500 cursor-pointer">
                  ...
                  <h3 className="font-semibold text-foreground text-base mb-2" style={{ fontFamily: 'Inter, sans-serif' }}>{step?.title}</h3>
                  <p className="text-muted-foreground text-sm leading-relaxed" style={{ fontFamily: 'Inter, sans-serif' }}>{step?.description}</p>

                  {/* Bottom accent line */}
                  <div className={`mt-5 h-0.5 w-0 group-hover:w-full bg-gradient-to-r ${step?.color} rounded-full transition-all duration-500`} />
                </div>
              </div>
            ))}
          </div>
